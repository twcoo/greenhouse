...
const { row, table } = defineProps<TableRowProps<Variety>>()

const isDeleteDialogOpen = ref<boolean>(false)

const handleUpdate = async (id: number, variety: Variety): Promise<void> => {
  await table.options.meta?.update(id, variety)
}
