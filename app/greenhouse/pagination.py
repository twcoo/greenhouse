                ...
                "data": {
                    ...
                    "properties": {
                        ...
                        "next": {
                            ...
                            "format": "uri",
                            "nullable": True,
                            "example": f"http://api.example.com/{settings.API_VERSION}/crops/?{self.page_query_param}=4",
                        ...
                        "previous": {
                            ...
                            "format": "uri",
                            "nullable": True,
                            "example": f"http://api.example.com/{settings.API_VERSION}/crops/?{self.page_query_param}=2",
