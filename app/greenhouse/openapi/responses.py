...
from .examples import (
    ...
    PLANTING_LOCATION_UPLOAD_IMAGE_TOO_LARGE_ERROR_EXAMPLE,
    PLANTING_LOCATION_UPLOAD_IMAGE_UNSUPPORTED_EXTENSION_ERROR_EXAMPLE,
    PLANTING_LOCATION_UPLOAD_INVALID_IMAGE_VALIDATION_ERROR_EXAMPLE,
