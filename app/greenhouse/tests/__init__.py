...
from .crops import CropGetApiViewTests as CropGetApiViewTests
from .crops import CropListApiViewTests as CropListApiViewTests
from .crops import \
    CropPartialUpdateApiViewTests as CropPartialUpdateApiViewTests
from .crops import CropUpdateApiViewTests as CropUpdateApiViewTests
