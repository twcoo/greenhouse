...
from .examples import (
    ...
    CROP_UPLOAD_IMAGE_RESPONSE_EXAMPLE, DUPLICATE_CROP_RESPONSE_EXAMPLE,
    ...
    SETUP_STATUS_OK_RESPONSE_EXAMPLE, SETUP_STATUS_REQUIRED_RESPONSE_EXAMPLE,
    UPDATE_CROP_RESPONSE_EXAMPLE, UPDATE_PLANTING_LOCATION_RESPONSE_EXAMPLE,
...
SETUP_STATUS_OK_RESPONSE = OpenApiResponse(
    description="Successful response indicating that the application setup status is OK.",
    response=CustomOpenAPIResponseSchema().get_schema(),
    examples=[
...
PLANTING_LOCATION_IMAGE_UPLOADED_RESPONSE = OpenApiResponse(
    description="Plating location image uploaded successfully.",
