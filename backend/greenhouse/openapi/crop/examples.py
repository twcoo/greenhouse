...
RETRIEVE_CROP_RESPONSE_EXAMPLE = OpenApiExample(
    ...
    description=(
        "Example response returning crop details for the " "specified ID."
    ),
    value={
        "status": "success",
        "data": {
...
CROP_NOT_FOUND_RESPONSE_EXAMPLE = OpenApiExample(
    ...
    description=(
        "Example response returned when no crop exists " "for the specified ID."
    ),
...
CREATE_CROP_RESPONSE_EXAMPLE = OpenApiExample(
    ...
    description=(
        "Example response returned after a crop is " "successfully created."
    ),
    value={
        "status": "success",
        "data": {
...
DUPLICATE_CROP_RESPONSE_EXAMPLE = OpenApiExample(
    ...
    description=(
        "Example response returned when a duplicate record " "already exists."
    ),
    status_codes=["400"],
    value={
        "status": "error",
...
UPDATE_CROP_RESPONSE_EXAMPLE = OpenApiExample(
    ...
    description=(
        "Example response indicating the crop was " "successfully updated."
    ),
    value={
        "status": "success",
        "data": {
